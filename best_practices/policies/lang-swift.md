---
id: lang-swift
title: Swift Language Policy
kind: language
includes: [shared-foundation]
check-count: 66
---

# Policy: Swift Language Policy

Merged Swift policy. It inlines the baseline `shared-foundation` checks and adds Swift-specific checks, including the language checks that previously lived in separate extended outputs. Enable for repositories with substantial Swift code. This policy already contains the shared foundation checks; add other `lang-*` policies only when the repo has another substantial implementation language.

## Language-Specific Checks

### Any app type
- [perf-swift-001](../extended/swift/perf-swift-001-computed-property-complexity.md) — Document non-constant computed property complexity.

### Library
- [doc-swift-001](../extended/swift/doc-swift-001-exported-swift-api-declarations-are-documented.md) — Exported Swift API declarations are documented.

### Other
- [rel-swift-001](../checks/swift/rel-swift-001-swiftui-state-main-thread.md) — SwiftUI state is mutated on the main thread.
