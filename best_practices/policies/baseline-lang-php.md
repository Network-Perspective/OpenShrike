---
id: baseline-lang-php
title: Baseline PHP Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline PHP Language Policy

Minimal PHP starter policy. It includes `baseline-shared-foundation` and adds one high-signal PHP-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-php`.
