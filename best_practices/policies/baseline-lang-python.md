---
id: baseline-lang-python
title: Baseline Python Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline Python Language Policy

Minimal Python starter policy. It includes `baseline-shared-foundation` and adds one high-signal Python-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-python`.
