...
import type {ScanFindingItem, ScanViewModel} from '../scan-view-model.js';

export function renderChecksHtml(viewModel: ScanViewModel): string {
...
function renderFindingRow(item: ScanFindingItem): string {
...
function renderStatusIcon(status: ScanFindingItem['status']): string {
  switch (status) {
    case 'fail':
      return `
