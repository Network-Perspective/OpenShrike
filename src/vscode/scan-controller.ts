...
import {createEmptyScanState, type ScanStatusKind} from './scan-data.js';
...
export class OpenShrikeScanController {
  ...
  private statusKind: ScanStatusKind = 'idle';
  ...
  private async refreshFromContext(statusKind: ScanStatusKind, statusLabel: string): Promise<void> {
    const context = this.requireContext();
