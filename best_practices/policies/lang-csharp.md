---
id: lang-csharp
title: C# Language Policy
kind: language
includes: [shared-foundation]
check-count: 82
---

# Policy: C# Language Policy

Merged C# policy. It inlines the baseline `shared-foundation` checks and adds C#-specific checks, including the language checks that previously lived in separate extended outputs. Enable for repositories with substantial C# code. This policy already contains the shared foundation checks; add other `lang-*` policies only when the repo has another substantial implementation language.

## Language-Specific Checks

### Any app type
- [csharp-rel-001](../checks/csharp/csharp-rel-001-cancellation-flows-through-async-and-long-running-work.md) — Cancellation flows through async and long-running work.
- [csharp-ops-005](../checks/csharp/csharp-ops-005-safe-startup-migrations.md) — Schema migrations are not applied unsafely on normal startup.
- [csharp-rel-005](../checks/csharp/csharp-rel-005-background-services-stop-cleanly.md) — Background services stop cleanly and do not spin on failure.
- [perf-csharp-001](../checks/csharp/perf-csharp-001-preload-related-data-before-iterating-navigation-properties.md) — Preload related data before iterating over navigation properties.
- [csharp-test-002](../checks/csharp/csharp-test-002-deterministic-time.md) — Time-dependent C# tests are deterministic.
- [csharp-arch-003](../checks/csharp/csharp-arch-003-dependency-injection-validated-early.md) — Dependency injection is validated early.
- [perf-csharp-003](../checks/csharp/perf-csharp-003-avoid-eager-loading-multiple-collection-navigations.md) — Avoid eager-loading multiple collection navigations in one query.
- [csharp-sec-002](../extended/csharp/csharp-sec-002-process-execution-does-not-concatenate-untrusted-input.md) — Process execution does not concatenate untrusted input.
- [csharp-sec-006](../extended/csharp/csharp-sec-006-raw-data-access-is-parameterized.md) — Raw data access is parameterized.
- [csharp-sec-007](../extended/csharp/csharp-sec-007-logs-do-not-expose-secrets-or-sensitive-payloads.md) — Logs do not expose secrets or sensitive payloads.
- [csharp-arch-005](../extended/csharp/csharp-arch-005-no-service-locator.md) — Application code does not use the service locator pattern.

### HTTP Service
- [rel-csharp-001](../checks/csharp/rel-csharp-001-avoid-blocking-on-async.md) — Async request and service code does not block on tasks or fake async.
- [rel-csharp-003](../checks/csharp/rel-csharp-003-request-scoped-context-and-services-not-captured-beyond-request.md) — Request-scoped context and services are not captured beyond the request.
- [csharp-api-002](../extended/csharp/csharp-api-002-consistent-machine-readable-errors.md) — HTTP APIs return consistent machine-readable errors.
- [csharp-api-003](../extended/csharp/csharp-api-003-collection-endpoints-bound-response-size.md) — Collection endpoints bound response size.

### HTTP Service, Batch Job, Other
- [csharp-api-001](../extended/csharp/csharp-api-001-external-inputs-are-validated-at-the-boundary.md) — External inputs are validated at the boundary.
- [csharp-sec-004](../extended/csharp/csharp-sec-004-protected-operations-enforce-authorization-at-the-boundary.md) — Protected operations enforce authorization at the boundary.

### Library
- [csharp-doc-002](../extended/csharp/csharp-doc-002-breaking-changes-called-out-in-release-notes.md) — Public breaking changes in C# packages are called out in release notes.
- [csharp-doc-001](../extended/csharp/csharp-doc-001-externally-consumed-public-csharp-apis-are-documented.md) — Externally consumed public C# APIs are documented.
