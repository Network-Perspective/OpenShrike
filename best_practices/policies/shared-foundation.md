...
title: Shared Foundation Policy
kind: foundation
check-count: 63
---

# Policy: Shared Foundation Policy

Cross-language baseline shared checks for all repositories. This policy is limited to the non-extended shared foundation. Use by itself when you only want the baseline shared cross-language coverage. Every `lang-*` policy inlines these checks.
