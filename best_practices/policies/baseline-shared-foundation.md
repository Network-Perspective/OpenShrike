---
id: baseline-shared-foundation
title: Baseline Shared Foundation Policy
kind: foundation
check-count: 19
---

# Policy: Baseline Shared Foundation Policy

Minimal cross-language starter checks for new OpenShrike adopters. This policy keeps the highest-signal shared checks from `shared-foundation` so teams can start with meaningful coverage without taking on the full library at once.
