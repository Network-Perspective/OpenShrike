---
id: baseline-lang-swift
title: Baseline Swift Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline Swift Language Policy

Minimal Swift starter policy. It includes `baseline-shared-foundation` and adds one high-signal Swift-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-swift`.
