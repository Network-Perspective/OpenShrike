...
export const OPENCODE_FIX_REQUEST_TIMEOUT_MS = 600_000;
export const OPENCODE_DELETE_TIMEOUT_MS = 5_000;
export const OPENCODE_POLL_TIMEOUT_MS = 90_000;
export const OPENCODE_FIX_POLL_TIMEOUT_MS = 600_000;
...
export const DOCKER_FIX_REQUEST_FILE = 'fix-request.json';
export const DOCKER_FIX_LOG_FILE = 'fix.log.jsonl';
