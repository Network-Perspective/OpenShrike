---
id: baseline-lang-python-ml
title: Baseline Python ML Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline Python ML Language Policy

Minimal Python ML starter policy. It includes `baseline-shared-foundation` and adds one high-signal Python ML-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-python-ml`.
