---
id: baseline-lang-javascript
title: Baseline JavaScript Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline JavaScript Language Policy

Minimal JavaScript starter policy. It includes `baseline-shared-foundation` and adds one high-signal JavaScript-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-javascript`.
