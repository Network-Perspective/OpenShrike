...
### Any app type
- [rel-cpp-001](../checks/cpp/rel-cpp-001-resource-ownership-raii-safe-copy-move-lifetime-semantics.md) — Resource ownership uses RAII with safe copy, move, and lifetime semantics.
- [rel-cpp-002](../checks/cpp/rel-cpp-002-concurrency-safety-on-every-path.md) — Locks, waits, atomics, and threads preserve concurrency safety on every path.
- [api-cpp-001](../checks/cpp/api-cpp-001-public-interface-contracts.md) — C++ public interfaces express dispatch, ownership, and range contracts explicitly.
- [rel-cpp-003](../extended/cpp/rel-cpp-003-avoid-lifetime-hazards.md) — Constructors, globals, and escaping lambdas avoid lifetime hazards.
- [perf-cpp-001](../extended/cpp/perf-cpp-001-release-queue-locks-before-processing-dequeued-work.md) — Release queue locks before processing dequeued work.
- [data-cpp-016](../extended/cpp/data-cpp-016-avoid-map-operator-for-lookup-only-reads.md) — Avoid map::operator[] for lookup-only reads.
