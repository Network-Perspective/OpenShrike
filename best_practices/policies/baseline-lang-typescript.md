---
id: baseline-lang-typescript
title: Baseline TypeScript Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline TypeScript Language Policy

Minimal TypeScript starter policy. It includes `baseline-shared-foundation` and adds one high-signal TypeScript-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-typescript`.
