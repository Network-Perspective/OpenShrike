---
id: baseline-lang-java
title: Baseline Java Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline Java Language Policy

Minimal Java starter policy. It includes `baseline-shared-foundation` and adds one high-signal Java-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-java`.
