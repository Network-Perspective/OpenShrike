---
id: baseline-lang-go
title: Baseline Go Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline Go Language Policy

Minimal Go starter policy. It includes `baseline-shared-foundation` and adds one high-signal Go-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-go`.
