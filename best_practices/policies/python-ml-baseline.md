# Python ML Baseline Policy

This policy extends `python-baseline` for classical machine learning and data
science code that trains, evaluates, and serves models.

## Policy metadata

- Policy ID: `python-ml-baseline`
- Scope: Python ML repositories and model-serving repos

## Included shared and Python checks
