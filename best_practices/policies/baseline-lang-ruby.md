---
id: baseline-lang-ruby
title: Baseline Ruby Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline Ruby Language Policy

Minimal Ruby starter policy. It includes `baseline-shared-foundation` and adds one high-signal Ruby-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-ruby`.
