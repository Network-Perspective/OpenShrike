---
id: baseline-lang-rust
title: Baseline Rust Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline Rust Language Policy

Minimal Rust starter policy. It includes `baseline-shared-foundation` and adds one high-signal Rust-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-rust`.
