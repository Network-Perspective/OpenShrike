---
id: lang-python-ml
title: Python ML Language Policy
kind: language
includes: [shared-foundation]
check-count: 72
---

# Policy: Python ML Language Policy

Enable for repositories with substantial Python ML code. This merged Python ML policy inlines the baseline `shared-foundation` checks and adds Python ML-specific checks, including the language checks that previously lived in separate extended outputs. This policy already contains the shared foundation checks; add other `lang-*` policies only when the repo has another substantial implementation language.

## Language-Specific Checks

### Any app type
- [python-ml-003](../checks/python-ml/python-ml-003-training-and-serving-share-preprocessing-contract.md) — Training and serving share the same preprocessing contract.
- [python-ml-002](../checks/python-ml/python-ml-002-evaluation-separated-from-training-data.md) — Evaluation is separated from training data.
- [rel-python-ml-003](../checks/python-ml/rel-python-ml-003-automated-actions-gated-on-model-confidence-or-plausibility.md) — Automated actions are gated on model confidence or plausibility.
- [test-python-ml-004](../checks/python-ml/test-python-ml-004-feature-extraction-fail-fast.md) — Feature extraction failures fail fast instead of degrading silently.
- [python-ml-001](../extended/python-ml/python-ml-001-prevent-leakage-in-python-ml-splitting-and-preprocessing.md) — Prevent leakage in Python ML splitting and preprocessing.
- [python-ml-004](../extended/python-ml/python-ml-004-experiments-are-reproducible-enough-to-explain-results.md) — Experiments are reproducible enough to explain results.
- [test-python-ml-002](../extended/python-ml/test-python-ml-002-reused-shuffled-scikit-learn-cv-splitters-use-integer-seeds.md) — Reused shuffled scikit-learn CV splitters use integer seeds.

### HTTP Service, Batch Job
- [ops-python-ml-003](../extended/python-ml/ops-python-ml-003-prediction-telemetry-records-model-identity.md) — Prediction telemetry records model identity.

### Library
- [test-python-ml-003](../extended/python-ml/test-python-ml-003-shared-randomstate-instance.md) — scikit-learn estimators do not share one mutable RandomState instance.
