---
id: lang-typescript
title: TypeScript Language Policy
kind: language
includes: [shared-foundation]
check-count: 69
---

# Policy: TypeScript Language Policy
...
### Any app type
- [rel-typescript-001](../checks/typescript/rel-typescript-001-validate-async-boundaries-before-side-effects.md) — Async boundary validation rejects invalid input before side effects.
- [rel-typescript-002](../checks/typescript/rel-typescript-002-consistent-async-timing-model.md) — Async APIs keep a consistent timing model.
- [sec-typescript-001](../extended/typescript/sec-typescript-001-parse-boundary-data-before-trusting-types.md) — Parse external TypeScript boundary data before trusting its type.
- [typescript-arch-001](../extended/typescript/typescript-arch-001-external-data-not-cast-directly-into-trusted-types.md) — External data is not cast directly into trusted types.
- [data-typescript-007](../extended/typescript/data-typescript-007-parse-unknown-data-before-use.md) — TypeScript boundaries parse unknown data before use.

### Library
- [doc-typescript-001](../extended/typescript/doc-typescript-001-exported-typescript-apis-documented-with-tsdoc.md) — Exported TypeScript APIs are documented with TSDoc.
