---
id: baseline-lang-kotlin
title: Baseline Kotlin Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline Kotlin Language Policy

Minimal Kotlin starter policy. It includes `baseline-shared-foundation` and adds one high-signal Kotlin-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-kotlin`.
