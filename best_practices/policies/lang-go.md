...
# Policy: Go Language Policy

Merged Go policy. It inlines the baseline `shared-foundation` checks and adds Go-specific checks, including the language checks that previously lived in separate extended outputs. Enable for repositories with substantial Go code. This policy already contains the shared foundation checks; add other `lang-*` policies only when the repo has another substantial implementation language.

## Language-Specific Checks

### Any app type
- [rel-go-001](../checks/go/rel-go-001-context-flows-per-call-and-detached-work-lifetime.md) — Context flows per call and detached work gets its own lifetime.
- [rel-go-002](../checks/go/rel-go-002-goroutine-coordination-and-shared-state.md) — Goroutine coordination and shared state are synchronized explicitly.
- [go-rel-002](../checks/go/go-rel-002-goroutines-have-explicit-lifecycle-ownership.md) — Goroutines have explicit lifecycle ownership.
- [data-go-014](../checks/go/data-go-014-mutable-slices-and-maps-boundaries.md) — Mutable slices and maps do not cross ownership or lock boundaries by alias.
- [api-go-002](../checks/go/api-go-002-explicit-error-signals-no-error-text-branching.md) — Go APIs expose explicit error signals and callers do not branch on error text.
- [go-arch-001](../extended/go/go-arch-001-context-propagates-across-request-and-io-boundaries.md) — Context propagates across request and I/O boundaries.
- [api-go-001](../extended/go/api-go-001-context-per-call-not-retained.md) — Go APIs accept per-call context and do not retain it on reusable objects.
- [go-rel-001](../extended/go/go-rel-001-http-clients-and-servers-define-explicit-time-budgets.md) — HTTP clients and servers define explicit time budgets.
- [go-sec-002](../extended/go/go-sec-002-parameterized-sql.md) — SQL remains parameterized.
- [go-sec-001](../extended/go/go-sec-001-command-execution-validates-input.md) — External command execution validates input.
- [rel-go-004](../extended/go/rel-go-004-package-initialization-is-deterministic-and-side-effect-free.md) — Package initialization is deterministic and side-effect free.
- [api-go-004](../extended/go/api-go-004-marshaled-go-structs-use-explicit-field-tags.md) — Marshaled Go structs use explicit field tags.

### HTTP Service
- [api-go-003](../extended/go/api-go-003-terminal-error-response-return.md) — Go HTTP handlers stop after writing a terminal error response.

### Library
- [api-go-005](../extended/go/api-go-005-library-flags-only-in-main.md) — Go libraries do not register command-line flags outside main packages.
