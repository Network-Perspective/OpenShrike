---
id: lang-kotlin
title: Kotlin Language Policy
kind: language
includes: [shared-foundation]
check-count: 65
---

# Policy: Kotlin Language Policy

Merged Kotlin policy. It inlines the baseline `shared-foundation` checks and adds Kotlin-specific checks, including the language checks that previously lived in separate extended outputs. Enable for repositories with substantial Kotlin code. This policy already contains the shared foundation checks; add other `lang-*` policies only when the repo has another substantial implementation language.

## Language-Specific Checks

### Any app type
- [data-kotlin-017](../extended/kotlin/data-kotlin-017-custom-equality-and-hash-codes-contract-safe.md) — Keep custom equality and hash codes contract-safe.

### Library
- [doc-kotlin-001](../extended/kotlin/doc-kotlin-001-public-kotlin-library-members-are-documented-with-kdoc.md) — Public Kotlin library members are documented with KDoc.
