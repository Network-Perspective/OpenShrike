---
id: baseline-lang-csharp
title: Baseline C# Language Policy
kind: language
includes: [baseline-shared-foundation]
check-count: 20
---

# Policy: Baseline C# Language Policy

Minimal C# starter policy. It includes `baseline-shared-foundation` and adds one high-signal C#-specific check. Use it when you want low-noise onboarding coverage before moving up to `lang-csharp`.
